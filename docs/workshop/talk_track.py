...
CHAPTERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "goal": "Walk the DQN loop, then train a mute Atari teacher. Recorded Mario clips are the evidence; live Mario is optional.",
        "slides": "section-dqn → what-is-dqn → dqn-q-values → dqn-bellman → dqn-replay → dqn-target → dqn-epsilon → dqn-curve → dqn-bridge → teacher-dataset",
        "slide_ids": (
            "section-dqn",
            "what-is-dqn",
            "dqn-q-values",
