...
CHAPTERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "goal": "Train a mute DQN, then watch the same loop improve Mario. Mario is optional intuition.",
        "slides": "dqn → mario intro → analogies → math → mario map → clips → teacher-dataset",
        "slide_ids": (
            "section-dqn",
            "dqn",
            "what-is-dqn",
    ...
    },
    {
        ...
        "title": "Packs",
        "heading": "## 6. Packs",
        "goal": "Turn mute teacher traces into curated SFT pairs and bake a shareable pack.",
